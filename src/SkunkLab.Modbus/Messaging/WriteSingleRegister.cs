...
namespace SkunkLab.Modbus.Messaging
{
    [Serializable]
    [JsonObject]
    public class WriteSingleRegister : ModbusMessage
    {
        public WriteSingleRegister()
        {
        }

        private const MessageType type = MessageType.WriteSingleRegister;
        ...
        public static WriteSingleRegister Decode(byte[] message, ILogger logger = null)
        {
            if (message == null)
            ...
            try
            {
                ...
                int index = 7;
                return new WriteSingleRegister()
                {
                    Header = header,
        ...
        public static WriteSingleRegister Decode(string message)
        {
            return JsonConvert.DeserializeObject<WriteSingleRegister>(message);
        }
